...
from util import read_args_from_config, execute_all_command, svn_checkout_parallel_with_map, svn_checkout_new_repo
...
if __name__ == '__main__':
    ...
    is_checkout_new, is_compile_project = read_args_from_config()
    if is_checkout_new:
        # can't use both, thread or map
        # svn_checkout_parallel_with_thread()
        # svn_checkout_parallel_with_map()
        svn_checkout_new_repo()
    if is_compile_project:
        execute_all_command()
